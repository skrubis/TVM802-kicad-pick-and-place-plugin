...
Then use the second option for machine data generation using your edited feeder template.

This is based on https://github.com/nica-f/tvm802-mdgen

Please create issue here if something does't work for you and I'll see how I can help.
